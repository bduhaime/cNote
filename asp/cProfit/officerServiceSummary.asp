	...
	<main id="mainContent" class="mdl-layout__content">
		...
		<!-- Your content goes here -->
			...
			<div class="mdl-grid">
				...
				<div class="mdl-cell mdl-cell--11-col mdl-shadow--2dp" style="padding: 15px; text-align: center;">
					...
					<div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label" style="display: block; text-align: center; background-color: rgb(228, 233, 244); width: 100%">
						<div style="display: inline-block;">
							<h9>
								<b><% =selectedSummary %>&nbsp;<% =selectedClass %> Services Overview</b>
							</h9>
						</div>
					</div>
					...
					<div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label" style="float: right;">
						<select id="drilldown" class="mdl-textfield__input" style="display: inline-block" onchange="SelectServiceDrilldown(<% =customerID %>,<% ="'" & selectedClass & "'" %>,this,<% ="'" & selectedMetric & "'" %>,<% ="'" & selectedSummary & "'" %>)">
							<option>Select an option...</option>
							<option>Return to overview</option>
					...
					<div id="dataTable" style="display: inline-block; text-align: center; padding: 15px; vertical-align: top">
						<!-- dataTable -->
					</div>
