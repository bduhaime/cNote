		...
		//----------------------------------------------------------------------------
			...
			var table = $('#cNoteDataTable')
				...
				.on( 'contextmenu', 'tbody tr', function(event) {
					...
					BuildContextMenu( customerID, 'branch', branchID, drillDownParms, event );
				})
				.DataTable({
					paging: true,
					info: true,
					...
					serverSide: false,
					ajax: {
						url: `${apiServer}/api/cProfit/branches`,
						type: 'POST',
...
// 							product: drillDownParms.product,
					...
					columnDefs: [
						{targets: 'branchDescription',	data: 'branchDescription', className: 'dt-body-left'},
						...
						{
							targets: 'loanInterest',
							data: 'loanInterest',
							className: 'loans dt-body-right',
						...
						{
							targets: 'depositInterest',		
							data: 'depositInterest',	
							className: 'deposits dt-body-right',
							render: function ( data, type, row ) {
								return parseFloat( data ).toFixed( 4 ) + '%';
							}
						},
						...
						{targets: 'totalBalance',			data: 'totalBalance',		className: 'total cNoteMoney dt-body-right', 	type: 'num-fmt', render: $.fn.dataTable.render.number(',', '.', 0, '$')},
...
<div class="mdl-layout mdl-js-layout mdl-layout--fixed-header">
	...
	<main id="mainContent" class="mdl-layout__content">
		...
		<div class="page-content">
			...
			<div class="mdl-grid">
				<div class="mdl-layout-spacer"></div>
				<div class="mdl-cell mdl-cell--9-col reportTitle">Branch Overview<br><% =subtitle %></div>
				<div class="mdl-layout-spacer"></div>
			</div>
			...
			<div class="mdl-grid">
				...
				<div class="mdl-cell mdl-cell--11-col mdl-shadow--2dp" style="padding: 15px;">
					...
					<table id="cNoteDataTable" class="compact display">
						<thead>
							<tr>
								<th class="branchDescription" rowspan="2">Branch</th>
							...
							<tr>
								...
								<th class="totalBalance">Balance</th>
