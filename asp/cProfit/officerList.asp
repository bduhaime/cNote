...
' capature the items that control this report...
			...
			<div class="mdl-grid">
				...
				<div class="mdl-cell mdl-cell--12-col mdl-shadow--2dp" style="padding: 15px;">
					...
					<div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label" style="display: block; text-align: center; background-color: rgb(228, 233, 244); width: 100%">
						...
						%>
						Branch: <% =branchTitle %>;&nbsp;&nbsp;Service Class: <% =groupTitle %>;&nbsp;&nbsp;Officer: <% =officerTitle %>
					</div>
					...
					if not rs.eof then 
						...
						<table align="center" class="cNoteTable sortable">
							<thead>
								<tr>
									<th class="alignLeft cNoteFixedCellXLarge"><div>Officer Name</div></th>
							...
							<tbody style="height: 550px;">
								...
								while not rs.eof 
									...
									next 	
									%>
									<tr id="<% =rs("officer name") %>" class="cNoteRow" 
										onclick="window.location.href='accountList.asp?id=<% =customerID %>&officer=<% =rs("officer name") %>&group=<% =groupName%>'"> 
										
										<td class="alignLeft cNoteFixedCellXLarge"><div><% =rs("officer name") %></div></td>
							...
							<tfoot>
									<tr> 
										...
										<td class="alignRight cNoteFixedCellXLarge"><div>Totals:</div></td>
