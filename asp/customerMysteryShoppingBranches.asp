...
userLog("Customer Mystery Shopping - Branches")
		...
		//====================================================================================
			...
			let table = $( '#branches' )
				.on( 'click', 'tbody > tr', function( event ) {
					const branch 		= $( '#branches' ).DataTable().row( this ).data().branch;
					const dateRange 	= $( '#dateRange' ).val();
					const startDate 	= $( '#startDate' ).val();
					const endDate 		= $( '#endDate' ).val();
					window.location.href = `customerMysteryShoppingSupervisors.asp?customerID=${customerID}&branch=${branch}&dateRange=${dateRange}&startDate${startDate}&endDate=${endDate}`;
				})
				.DataTable({
					ajax: {
						url: `${apiServer}/api/mysteryShopping/branches`,
						data: { 
					...
					columnDefs: [
						...
						{targets: 'totalSupervisors', 	data: 'totalSupervisors',		className: 'totalSupervisors dt-body-center' },
...
<!-- #include file="includes/customerTabs.asp" -->
	...
	<main id="mainContent" class="mdl-layout__content">
   	...
   	<div class="mdl-grid">
		   ...
		   <div><h4>Mystery Shopping - Branches</h4></div>
   	...
   	<div class="mdl-grid">
		   ...
		   <div class="mdl-cell mdl-cell--9-col">
				...
				<table id="branches" class="compact display">
					<thead>
						<tr>
							<th class="branch" rowspan="2">Branch</th>
							<th class="totalBankers" rowspan="2"># Bankers</th>
							<th class="totalSupervisors" rowspan="2"># Supervisors</th>
