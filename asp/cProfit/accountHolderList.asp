...
SQL = "select " &_
			...
			"max(decile) as decile, " &_
			"max(centile) as centile " &_
			...
			<div class="mdl-grid">
				...
				<div id="cNoteTableParent" class="mdl-cell mdl-cell--12-col mdl-shadow--2dp" style="padding: 15px;">
					...
					<div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label" style="display: block; text-align: center; background-color: rgb(228, 233, 244); width: 100%">
						...
						%>
						Branch: <% =branchTitle %>;&nbsp;&nbsp;Service Class: <% =groupTitle %>;&nbsp;&nbsp;Officer: <% =officerName %>
					</div>
					...
					if not rs.eof then 
						...
						<table align="center" class="cNoteTable">
							<thead>
								<tr>
									<th class="alignLeft cNoteFixedCellMedium" data-sort="accountHolderNumber">Account Holder #</th>
									<th class="alignLeft cNoteFixedCellHuge" data-sort="accountHolderName">Account Holder Name</th>
									<th class="alignCenter cNoteFixedCellTiny sort" data-sort="addenda"><i class="material-icons" style="width: 32px;">comment</i></th>
									<th class="alignCenter cNoteFixedCellSmall sort" data-sort="accountHolderGrade">Grade</th>
									<th class="alignRight cNoteFixedCellSmall sort" data-sort="accountCount"># Accts</th>
									...
									<th class="alignCenter cNoteFixedCellSmall sort" data-sort="decile">Decile</th>
									<th class="alignCenter cNoteFixedCellSmall sort" data-sort="centile">Centile</th>

								</tr>
							</thead>
							<tbody class="list" style="height: <% =bodyHeight %>px;">
								<% 
								while not rs.eof 
								for i = 3 to 11 
								...
								next 	
									%>
									<tr id="<% =rs("account holder number") %>" class="cNoteRow"> 
										...
										<td class="alignCenter cNoteFixedCellSmall accountHolderGrade"><% =rs("account holder grade") %></td>
										<td class="alignRight cNoteFixedCellSmall cNoteMoney accountCount"><% =formatNumber(rs("accountCount"),0) %></td>
										...
										<td class="alignCenter cNoteFixedCellSmall decile"><% =rs("decile") %></td>
										<td class="alignCenter cNoteFixedCellSmall centile"><% =rs("centile") %></td>
							...
							<tfoot>
									<tr> 
<!-- 										<td class="alignRight" style="width: 207px;"><div>Totals:</div></td> -->
										<td class="alignRight cNoteFixedCellXLarge" colspan="4" style="width: 395px;">Totals:</td>
										<td class="alignRight cNoteFixedCellSmall cNoteMoney"><% =formatNumber(totalsArray(3),0) %></td>
										...
										<td class="alignRight cNoteFixedCellLarge cNoteMoney"><% =formatCurrency(totalsArray(11),0) %></td>
										<td class="alignCenter cNoteFixedCellSmall">&nbsp;</div></td>
										<td class="alignCenter cNoteFixedCellSmall">&nbsp;</div></td>
...
<script>
	...
	reportList.on('sortStart',function() {
// 		alert('sort Start');
	})	
