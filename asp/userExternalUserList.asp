...
title = session("clientID") & " - <a href=""executiveDashboard.asp"">Executive Dashboard</a> > Internal Users That Are External Users"
userLog(title)
    ...
    <script type="text/javascript">
	   ...
	   'use strict';
		...
		//================================================================================================ 
			...
			let table = $( '#internalExternalUsers' )
				.on( 'click', 'tbody > tr', function(event) {
					const userID = this.id;

// 				window.location.href = `userEdit.asp?id=${userID}`;

// 				alert( 'This user can only be viewed/edited from the administrative cNote client. Please switch clients or contact your system administrator.' );
					$( '#dialog' ).dialog( "open" );
										
				})
				.DataTable({
					ajax: {
						url: `${apiServer}/api/exec/internalExternalUsers`,
...
<body>
	...
	<div id="dialog" title="Attention">
		<p>In order to view/edit internal users that are also external users, you must use the administrative cNote client. Please switch clients or contact your system administrator.</p>
	</div>
	...
	<div class="page-content"><!-- Your content goes here -->
   	...
   	<div class="mdl-grid">
		   ...
		   <div class="mdl-cell mdl-cell--5-col">
				...
				<table id="internalExternalUsers" class="compact display">
					<thead>
						<tr>
