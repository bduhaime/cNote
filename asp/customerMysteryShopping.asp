	...
	<main id="mainContent" class="mdl-layout__content">
		...
		<div class="page-content">
			...
			<div class="mdl-grid">
				...
				<div class="mdl-cell mdl-cell--3-col mdl-shadow--2dp controls">
			...
			<div class="mdl-grid">
				...
				<div class="mdl-cell mdl-cell--4-col mdl-shadow--2dp">
					<div id="byBranchChart_progressbar"></div>
					<div id="byBranchChart" style="height: 400px;"></div>
				...
				<div class="mdl-cell mdl-cell--4-col mdl-shadow--2dp">
					<div id="bySupervisor_progressbar"></div>
					<div id="bySupervisor" style="height: 400px;"></div>
				</div><!-- Average Score By Supervisor (Chart) -->
